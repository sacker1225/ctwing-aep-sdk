...
//
//	描述:
func GetSubscriptionsList(appKey string, appSecret string, productId string, pageNow string, pageSize string, MasterKey string, subType string, searchValue string, deviceGroupId string) (*http.Response, error) {
...
//
//	描述:body,具体参考平台api说明
func CreateDestHttpUrl(appKey string, appSecret string, body string, MasterKey string) (*http.Response, error) {
