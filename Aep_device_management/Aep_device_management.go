...
//
//	描述:body,具体参考平台api说明
func ListDeviceInfo(appKey string, appSecret string, MasterKey string, body string) (*http.Response, error) {
...
//
//	描述:body,具体参考平台api说明
func DeleteDeviceByPost(appKey string, appSecret string, MasterKey string, body string) (*http.Response, error) {
...
//
//	描述:body,具体参考平台api说明
func ListDeviceActiveStatus(appKey string, appSecret string, MasterKey string, body string) (*http.Response, error) {
...
//
//	描述:body,具体参考平台api说明
func BatchCreateDevice(appKey string, appSecret string, MasterKey string, body string) (*http.Response, error) {
